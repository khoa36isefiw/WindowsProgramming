    ...
    public partial class frmAddStudent : Form
    {
        ...
        */
        ...
        private void btnAddStudent_Click(object sender, EventArgs e)
        {
            ...
            #region Catch Exception for each textbox or gì đó?
            ...
            //// nếu không đủ tuổi  thì hiện
            //if ((this_year - born_year) < 17 || ((this_year - born_year) > 100))
            //{

            //    MessageBox.Show("Sinh viên phải từ 18 tuổi trở lên", "Tuổi không hợp lệ!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            //}
            ...
            //{
            //    MessageBox.Show("Sinh viên đã tồn tại!","Confirm", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //}
            ...
            //// try catch for fname, lname    = txtLastName.Text
            //try
            //{
            //    if (string.IsNullOrEmpty(txtFirstName.Text) || txtFirstName.Text.Any(char.IsDigit)
            //        || string.IsNullOrEmpty(txtLastName.Text) || txtLastName.Text.Any(char.IsDigit))
            //    {
            //        MessageBox.Show("Tên không chứa chữ số hoặc khoảng trắng!");
            //    }
            //    else
            //    {
            //       fName = txtFirstName.Text;      // ngoài ra có thể xét trong event
